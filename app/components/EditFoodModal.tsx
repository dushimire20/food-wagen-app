...
const EditFoodModal: React.FC<EditFoodModalProps> = ({ food, onClose, onSave }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updatedFood = await updateFood(food.id, formData);
      onSave(updatedFood);
    } catch (err) {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 w-4/6 mx-auto">
      <div className="bg-white rounded-lg p-6 w-full  px-16 py-10 mx-4">
        <h2 className="text-xl font-bold mb-4 text-center text-accent-400">Edit Food</h2>
